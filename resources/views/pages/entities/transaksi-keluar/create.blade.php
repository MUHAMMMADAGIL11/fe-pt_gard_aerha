...
@section('content')
    <div class="space-y-8 px-4 sm:px-6 lg:px-8">
        <div>
            ...
            <h1 class="text-2xl sm:text-[26px] font-bold text-white mt-3">Catat Barang Keluar</h1>
            <p class="text-sm text-slate-300 mt-1.5">Kurangi stok barang dengan mencatat transaksi keluar.</p>
        </div>

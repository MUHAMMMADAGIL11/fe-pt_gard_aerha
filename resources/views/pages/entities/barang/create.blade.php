...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-[#0F2536] rounded-2xl shadow-[0_18px_45px_rgba(0,0,0,0.45)] border border-white/5 p-6 sm:p-8">
            <form method="POST" action="{{ route('barang.store') }}" class="space-y-6" data-loading="true">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2 space-y-2">
                        <label for="id_kategori" class="block text-sm font-semibold text-white">Kategori</label>
                        <div class="relative select-with-icon">
                            <select id="id_kategori" name="id_kategori" required
                                class="w-full rounded-xl border {{ $errors->has('id_kategori') ? 'border-rose-400' : 'border-white/10' }} bg-[#152c3f] pl-4 pr-12 py-3 text-sm text-white appearance-none focus:border-[#B69364] focus:ring-2 focus:ring-[#B69364]/20">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="kode_barang" name="kode_barang" value="{{ old('kode_barang') }}"
                            ...
                            class="w-full rounded-xl border {{ $errors->first('kode_barang') ? 'border-rose-400' : 'border-white/10' }} bg-[#152c3f] px-4 py-3 text-sm text-white placeholder:text-slate-400 focus:border-[#B69364] focus:ring-2 focus:ring-[#B69364]/20">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nama_barang" name="nama_barang" value="{{ old('nama_barang') }}"
                            ...
                            class="w-full rounded-xl border {{ $errors->first('nama_barang') ? 'border-rose-400' : 'border-white/10' }} bg-[#152c3f] px-4 py-3 text-sm text-white placeholder:text-slate-400 focus:border-[#B69364] focus:ring-2 focus:ring-[#B69364]/20">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" id="stok" name="stok" value="{{ old('stok') }}"
                            placeholder="Masukkan stok sekarang"
                            class="w-full rounded-xl border {{ $errors->first('stok') ? 'border-rose-400' : 'border-white/10' }} bg-[#152c3f] px-4 py-3 text-sm text-white placeholder:text-slate-400 focus:border-[#B69364] focus:ring-2 focus:ring-[#B69364]/20">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" id="stok_minimum" name="stok_minimum" value="{{ old('stok_minimum') }}"
                            placeholder="Masukkan stok minimum"
                            class="w-full rounded-xl border {{ $errors->first('stok_minimum') ? 'border-rose-400' : 'border-white/10' }} bg-[#152c3f] px-4 py-3 text-sm text-white placeholder:text-slate-400 focus:border-[#B69364] focus:ring-2 focus:ring-[#B69364]/20">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-4">
                    <a href="{{ route('barang.index') }}"
                        class="inline-flex justify-center rounded-xl border border-white/10 bg-transparent px-6 py-3 text-sm font-semibold text-white hover:bg-white/5">Batal</a>

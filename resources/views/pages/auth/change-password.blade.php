...
@section('content')
    <div class="space-y-8">
        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-6" data-loading="true">
            @csrf
            <div class="space-y-2">
                <label for="password" class="block text-[14px] font-semibold text-[#1A1A1A]">Password Baru</label>
            ...
            <div class="space-y-2">
                <label for="password_confirmation" class="block text-[14px] font-semibold text-[#1A1A1A]">Konfirmasi Password</label>
                <div class="relative mt-2">
